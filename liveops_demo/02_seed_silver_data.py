...
df_events.write.mode("overwrite").saveAsTable("main.liveops_demo.silver_game_events")
df_payments.write.mode("overwrite").saveAsTable("main.liveops_demo.silver_payments")

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT date_trunc('hour', event_ts) AS h, count(*) AS cnt
# MAGIC FROM main.liveops_demo.silver_game_events
